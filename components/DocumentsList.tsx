...
export default function DocumentsList() {
  ...
  const documents: Document[] = [
    { id: 1, name: 'Q1 Financial Report', type: 'PDF', size: '2.4 MB', owner: 'John Smith', createdDate: '2024-01-15', lastModified: '2024-01-15 10:30:00', status: 'Active' },
    { id: 2, name: 'Marketing Strategy 2024', type: 'DOCX', size: '1.8 MB', owner: 'Sarah Johnson', createdDate: '2024-01-14', lastModified: '2024-01-15 09:15:00', status: 'Active' },
    { id: 3, name: 'Employee Handbook', type: 'PDF', size: '3.2 MB', owner: 'Mike Chen', createdDate: '2024-01-10', lastModified: '2024-01-15 09:45:00', status: 'Active' },
    { id: 4, name: 'Project Timeline', type: 'XLSX', size: '856 KB', owner: 'Emily Davis', createdDate: '2024-01-12', lastModified: '2024-01-15 08:20:00', status: 'Archived' },
    { id: 5, name: 'Company Policies', type: 'PDF', size: '1.5 MB', owner: 'Robert Wilson', createdDate: '2024-01-08', lastModified: '2024-01-14 16:30:00', status: 'Active' },
    { id: 6, name: 'Budget Analysis', type: 'XLSX', size: '2.1 MB', owner: 'John Smith', createdDate: '2024-01-05', lastModified: '2024-01-13 14:45:00', status: 'Active' },
    { id: 7, name: 'Meeting Notes', type: 'DOCX', size: '245 KB', owner: 'Sarah Johnson', createdDate: '2024-01-03', lastModified: '2024-01-12 11:20:00', status: 'Archived' },
    { id: 8, name: 'Technical Specifications', type: 'PDF', size: '4.7 MB', owner: 'Mike Chen', createdDate: '2023-12-28', lastModified: '2024-01-11 15:10:00', status: 'Active' }
  ];
                ...
                <tr key={doc.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-900 dark:text-white">{doc.owner}</span>
                    </div>
                  </td>
